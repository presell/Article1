...
import sty from "./Plasmic_320PxNavBar.module.css"; // plasmic-import: DbWNBtshboJ/css

import Frame4Icon from "./icons/PlasmicIcon__Frame4"; // plasmic-import: J7ACpc7u7nE1i/icon
