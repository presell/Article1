...
import Reviews from "../../Reviews"; // plasmic-import: do_pvsu54v637/component
...
import sty from "./PlasmicArticleIntro.module.css"; // plasmic-import: 95n2t80S5P4dw/css
  ...
  return (
    ...
    >
      ...
      {(hasVariant(globalVariants, "screen", "desktopOnly") ? true : true) ? (
        ...
        >
          <div className={classNames(projectcss.all, sty.column__odNgj)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__iQofh)}>
            <div
