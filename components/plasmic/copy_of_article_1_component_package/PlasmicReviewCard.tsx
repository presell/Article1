...
import sty from "./PlasmicReviewCard.module.css"; // plasmic-import: e5s2VYmT1exKJ/css
  ...
  return (
    true ? (
      ...
      >
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__n20Mo)}
          ...
          src={{
            src: "/plasmic/copy_of_article_1_component_package/images/sidereview1Png.png",
            fullWidth: 119,
            fullHeight: 119,
        ...
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img___7QISw)}
