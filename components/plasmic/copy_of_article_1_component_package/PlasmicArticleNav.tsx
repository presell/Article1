...
import sty from "./PlasmicArticleNav.module.css"; // plasmic-import: fTi59to2CoiUH/css
  ...
  return (
    (
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__r9Kq)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/copy_of_article_1_component_package/images/logopng.png",
                fullWidth: 276,
                fullHeight: 46,
          ...
          <div className={classNames(projectcss.all, sty.column__s2Ixk)}>
            <div
